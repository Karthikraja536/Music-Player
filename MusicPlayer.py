...
button_style = {"bg": "#e94560", "fg": "white", "font": ("Arial", 12), "activebackground": "#0f3460"}
label_style = {"bg": "#1a1a2e", "fg": "#f7f7f7", "font": ("Arial", 16, "bold")}

title_label = tk.Label(root, text="Music Player", **label_style)
title_label.grid(row=0, column=0, columnspan=4, pady=20)

song_list = tk.Listbox(root, bg="#16213e", fg="white", font=("Arial", 12), width=60, height=15, selectbackground="#e94560")
